...
Today's this time of the year called WWDC, so I thought it's a perfect opportunity to publish this longstanding draft about my MacBook, so enjoy the roller-coaster!
...
In a few days, BigMac's owner arrived at our place. I with my Dad asked some things about him, turned him on, and checked some basic things like the system info window, webcam, and charger, but nothing more, since it was our first encounter with such a machine.
...
Later that day, I realized the problem with High Sierra: it's an old version and BigMac doesn't receive updates anymore. After some quick googling, I found out about something called macOS patchers. An hour later, I had a USB stick with macOS Mojave at hands. I booted BigMac into it, installed Mojave only to discover an issue with BigMac: his GPU was malfunctioning. After a quick lookup, it turned out to be a common and expensive issue to fix. So the next day, the previous owner and my Dad agreed on returning the device without any change in price, and it was returned the same day, fortunately all went smoothly.
...
MacBoy was shocked: "Did I not just become useful again, but also became up-to-date again? My sensors aren't lying?"

It was in fact real, I was incredibly happy to have a new friend, and so was MacBoy.

Time passed, macOS Catalina was released, and it was time for an upgrade. I repeated the same steps as when he installed Mojave. It had some glitches here and there, but otherwise, it was perfectly usable.
...
After trying to clean it without much success, we (my Dad and I) went for a replacement. While at the parts shop, we got some upgrades for it: an optibay (thingy that goes in place of the CD-ROM that allows putting a regular SATA drive in it) and an SSD. At home, I replaced the keyboard, with some struggling but still, upgrades were installed, and it was working like a charm.
...
And so, Catalina it was again. But then I remembered about when I watched some videos about some OS that allowed some nice customization, like you could make windows act like jelly and all that. So I found these videos and turned out that OS was Manjaro, fast forward some time, I flashed a USB stick with Manjaro and installed it on MacBoy.
...
Everything was good now; MacBoy and the owner were happy to be together again, without the bad influence of his parent company. Time passed, new Fedora versions came out, the owner distro-hopped more, but every time returned to Fedora, migrated from Workstation to Silverblue, learned more about FOSS, and even started contributing translations and later on, even icons. But everything good comes to an end.
...
<figcaption>For some reason I decided to try ChromeOS, yes it was pure dogshit, even linux container didn't work</figcaption>

![macbook endeavouros](macbook-endeavouros.jpg)
<figcaption>For some time I daily-drived EndeavourOS, such a good distro but not exactly for me</figcaption>
...
MacBoy was put in a drawer until better times when a new charger could be bought. In the meantime, the owner moved to his mom's laptop to not lose access to a computer entirely.

When the time came, a new charger was bought, and MacBoy was finally working again, but not for long. Very soon, he stopped charging. Since the charger was new, the suspicion fell on the battery, so I used it by powering it on without the battery by disconnecting the battery, holding power button for 5 seconds and while holding it connecting the charger and then releasing the power button after 5 seconds. Half a year later, new charger were purchased, all this time Mom's laptop was used.

The charger worked a single day and then stop charging. After a month or so, some budget to go to the repair shop was at hands and we went there, showed the problem and—WAIT IT WORKS, WTF!? Yep, it does; "I will shove the old battery up Satan's ass" I thought. To not lose time on nothing, we replaced the noisy fan that bacame noisy in the period of waiting for new charger, broken HDD cable that unexpectedly died one day, and repasted the CPU and we went back home.
...
To say that I was sad is like saying nothing, I was absolutely crushed knowing that we're not in the best financial situation and that fucker kept sucking family's money and my soul.
...
Ten days have passed, no call from the repair shop, so Dad called first. The answer followed:
...
Two weeks later, no call from the repair shop, so Dad once again calls first. The answer:
